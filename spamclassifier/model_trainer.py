...
def train_svm():
    ...
    dataset_train = loadmat(jp(dn(__file__), 'data', 'dataset', 'spamTrain.mat'))
    X_train = dataset_train['X']
    y_train = dataset_train['y'].ravel()
...
def evaluate_model(classifier_model, X_train, y_train):
    ...
    dataset_test = loadmat(jp(dn(__file__), 'data', 'dataset', 'spamTest.mat'))
